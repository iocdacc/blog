...
2. **函数(function)** 是一个非常特殊的对象，它不仅可以实例新的对象，而且所有构造方法的 **\_\_porto\_\_** 都指向他的**prototype**,包括他自己（他自己也是构造方法）和**Object**。而他的 **\_\_porto\_\_** 又指向**Object**的**prototype**。 总结一下，所有构造方法的原型都指向**函数(function)**的**prototype**，其他普通对象的原型指向，实例他们的构造方法的**prototype**。
