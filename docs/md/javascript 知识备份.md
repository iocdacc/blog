...
4. 关于**箭头函数**和**函数**的**this**问题。**函数**的**this**通过谁调用它，它的this就是谁。**箭头函数**的**this**定义的时候外层有没有其他父函数如果有，**this**就是外层父函数的**this**，没有其他父函数则**this**是window。
